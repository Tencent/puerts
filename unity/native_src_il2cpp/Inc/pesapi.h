...
typedef void (*pesapi_callback)(struct pesapi_apis* api, pesapi_callback_info info);
typedef void* (*pesapi_constructor)(struct pesapi_apis* api, pesapi_callback_info info);
typedef void (*pesapi_finalize)(struct pesapi_apis* api, void* ptr, void* class_data, void* env_private);
...
struct pesapi_apis
{
    ...
    pesapi_create_boolean_func pesapi_create_boolean;
    pesapi_create_int32_func pesapi_create_int32;
    pesapi_create_uint32_func pesapi_create_uint32;
    pesapi_create_int64_func pesapi_create_int64;
    pesapi_create_uint64_func pesapi_create_uint64;
    pesapi_create_double_func pesapi_create_double;
    pesapi_create_string_utf8_func pesapi_create_string_utf8;
    pesapi_create_binary_func pesapi_create_binary;
    pesapi_create_array_func pesapi_create_array;
    pesapi_create_object_func pesapi_create_object;
    pesapi_create_function_func pesapi_create_function;
    pesapi_create_class_func pesapi_create_class;
    pesapi_get_value_bool_func pesapi_get_value_bool;
    pesapi_get_value_int32_func pesapi_get_value_int32;
    pesapi_get_value_uint32_func pesapi_get_value_uint32;
    pesapi_get_value_int64_func pesapi_get_value_int64;
    pesapi_get_value_uint64_func pesapi_get_value_uint64;
    pesapi_get_value_double_func pesapi_get_value_double;
    pesapi_get_value_string_utf8_func pesapi_get_value_string_utf8;
    pesapi_get_value_binary_func pesapi_get_value_binary;
    pesapi_get_array_length_func pesapi_get_array_length;
    pesapi_is_null_func pesapi_is_null;
    pesapi_is_undefined_func pesapi_is_undefined;
    pesapi_is_boolean_func pesapi_is_boolean;
    pesapi_is_int32_func pesapi_is_int32;
    pesapi_is_uint32_func pesapi_is_uint32;
    pesapi_is_int64_func pesapi_is_int64;
    pesapi_is_uint64_func pesapi_is_uint64;
    pesapi_is_double_func pesapi_is_double;
    pesapi_is_string_func pesapi_is_string;
    pesapi_is_object_func pesapi_is_object;
    pesapi_is_function_func pesapi_is_function;
    pesapi_is_binary_func pesapi_is_binary;
    pesapi_is_array_func pesapi_is_array;
    pesapi_native_object_to_value_func pesapi_native_object_to_value;
    pesapi_get_native_object_ptr_func pesapi_get_native_object_ptr;
    pesapi_get_native_object_typeid_func pesapi_get_native_object_typeid;
    pesapi_is_instance_of_func pesapi_is_instance_of;
    pesapi_boxing_func pesapi_boxing;
    pesapi_unboxing_func pesapi_unboxing;
    pesapi_update_boxed_value_func pesapi_update_boxed_value;
    pesapi_is_boxed_value_func pesapi_is_boxed_value;
    pesapi_get_args_len_func pesapi_get_args_len;
    pesapi_get_arg_func pesapi_get_arg;
    pesapi_get_env_func pesapi_get_env;
    pesapi_get_this_func pesapi_get_this;
    pesapi_get_holder_func pesapi_get_holder;
    pesapi_get_userdata_func pesapi_get_userdata;
    pesapi_add_return_func pesapi_add_return;
    pesapi_throw_by_string_func pesapi_throw_by_string;
    pesapi_create_env_ref_func pesapi_create_env_ref;
    pesapi_env_ref_is_valid_func pesapi_env_ref_is_valid;
    pesapi_get_env_from_ref_func pesapi_get_env_from_ref;
    pesapi_duplicate_env_ref_func pesapi_duplicate_env_ref;
    pesapi_release_env_ref_func pesapi_release_env_ref;
    pesapi_open_scope_func pesapi_open_scope;
    pesapi_open_scope_placement_func pesapi_open_scope_placement;
    pesapi_has_caught_func pesapi_has_caught;
    pesapi_get_exception_as_string_func pesapi_get_exception_as_string;
    pesapi_close_scope_func pesapi_close_scope;
    pesapi_close_scope_placement_func pesapi_close_scope_placement;
    pesapi_create_value_ref_func pesapi_create_value_ref;
    pesapi_duplicate_value_ref_func pesapi_duplicate_value_ref;
    pesapi_release_value_ref_func pesapi_release_value_ref;
    pesapi_get_value_from_ref_func pesapi_get_value_from_ref;
    pesapi_set_ref_weak_func pesapi_set_ref_weak;
    pesapi_set_owner_func pesapi_set_owner;
    pesapi_get_ref_associated_env_func pesapi_get_ref_associated_env;
    pesapi_get_ref_internal_fields_func pesapi_get_ref_internal_fields;
    pesapi_get_property_func pesapi_get_property;
    pesapi_set_property_func pesapi_set_property;
    pesapi_get_private_func pesapi_get_private;
    pesapi_set_private_func pesapi_set_private;
    pesapi_get_property_uint32_func pesapi_get_property_uint32;
    pesapi_set_property_uint32_func pesapi_set_property_uint32;
    pesapi_call_function_func pesapi_call_function;
    pesapi_eval_func pesapi_eval;
    pesapi_global_func pesapi_global;
    pesapi_get_env_private_func pesapi_get_env_private;
    pesapi_set_env_private_func pesapi_set_env_private;
};
