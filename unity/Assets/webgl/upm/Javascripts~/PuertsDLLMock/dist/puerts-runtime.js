...
class ObjectMapper {
    ...
    bindNativeObject(objId, jsObj, typeId, cls, callFinalize) {
        ...
        const ud = cls.$OnEnter?.(objId, cls.$ClassData, this.privateData);
