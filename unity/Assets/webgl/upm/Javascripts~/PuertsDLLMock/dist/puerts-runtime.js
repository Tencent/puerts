...
function WebGLRegsterApi(engine) {
    ...
    return {
        ...
        pesapi_define_class: function (typeId, superTypeId, name, constructor, finalize, propertyCount, properties, data) {
