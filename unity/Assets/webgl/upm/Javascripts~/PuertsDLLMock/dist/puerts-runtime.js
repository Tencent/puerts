...
function pesapi_create_null(env) {
    console.log(`create_null ${env}`);
    return 1;
}
function pesapi_create_undefined(env) {
    console.log(`create_undefined ${env}`);
    return 2;
}
...
// 类似地处理其他基础类型创建函数
function pesapi_create_uint32(env, value) { return 0; }
function pesapi_create_int64(env, value) { return 0; }
function pesapi_create_uint64(env, value) { return 0; }
function pesapi_create_double(env, value) { return 0; }
...
function pesapi_create_array(env) { return 0; }
function pesapi_create_object(env) { return 0; }
...
// 类似处理其他类型获取
function pesapi_get_value_uint32(env, pvalue) { return 0; }
function pesapi_get_value_int64(env, pvalue) { return 0n; }
function pesapi_get_value_uint64(env, pvalue) { return 0n; }
function pesapi_get_value_double(env, pvalue) { return 0; }
...
// --------------- 类型检查系列 ---------------
function pesapi_is_null(env, pvalue) { return false; }
function pesapi_is_undefined(env, pvalue) { return false; }
function pesapi_is_boolean(env, pvalue) { return false; }
function pesapi_is_int32(env, pvalue) { return false; }
function pesapi_is_uint32(env, pvalue) { return false; }
function pesapi_is_int64(env, pvalue) { return false; }
function pesapi_is_uint64(env, pvalue) { return false; }
function pesapi_is_double(env, pvalue) { return false; }
function pesapi_is_string(env, pvalue) { return false; }
function pesapi_is_object(env, pvalue) { return false; }
function pesapi_is_function(env, pvalue) { return false; }
function pesapi_is_binary(env, pvalue) { return false; }
function pesapi_is_array(env, pvalue) { return false; }
// --------------- 对象操作系列 ---------------
...
// --------------- 装箱/拆箱 ---------------
function pesapi_boxing(env, pvalue) { return 0; }
function pesapi_unboxing(env, p_boxed_value) { return 0; }
function pesapi_update_boxed_value(env, p_boxed_value, pvalue) { }
function pesapi_is_boxed_value(env, value) { return false; }
// --------------- 函数调用相关 ---------------
function pesapi_get_args_len(pinfo) { return 0; }
function pesapi_get_arg(pinfo, index) { return 0; }
function pesapi_get_env(pinfo) { return 0; }
function pesapi_get_this(pinfo) { return 0; }
function pesapi_get_holder(pinfo) { return 0; }
function pesapi_get_userdata(pinfo) { return 0; }
function pesapi_add_return(pinfo, value) { }
function pesapi_throw_by_string(pinfo, msg) { }
// --------------- 环境引用 ---------------
function pesapi_create_env_ref(env) { return 0; }
function pesapi_env_ref_is_valid(penv_ref) { return false; }
function pesapi_get_env_from_ref(penv_ref) { return 0; }
function pesapi_duplicate_env_ref(penv_ref) { return 0; }
function pesapi_release_env_ref(penv_ref) { }
// --------------- 作用域管理 ---------------
function pesapi_open_scope(penv_ref) { return 0; }
function pesapi_open_scope_placement(penv_ref, memory) { return 0; }
function pesapi_has_caught(pscope) { return false; }
function pesapi_get_exception_as_string(pscope, with_stack) { return ""; }
function pesapi_close_scope(pscope) { }
function pesapi_close_scope_placement(pscope) { }
// --------------- 值引用 ---------------
function pesapi_create_value_ref(env, pvalue, internal_field_count) { return 0; }
function pesapi_duplicate_value_ref(pvalue_ref) { return 0; }
function pesapi_release_value_ref(pvalue_ref) { }
function pesapi_get_value_from_ref(env, pvalue_ref) { return 0; }
function pesapi_set_ref_weak(env, pvalue_ref) { }
function pesapi_set_owner(env, pvalue, powner) { return false; }
function pesapi_get_ref_associated_env(value_ref) { return 0; }
function pesapi_get_ref_internal_fields(pvalue_ref, pinternal_field_count) { return 0; }
// --------------- 属性操作 ---------------
function pesapi_get_property(env, pobject, key) { return 0; }
function pesapi_set_property(env, pobject, key, pvalue) { }
function pesapi_get_private(env, pobject, out_ptr) { return false; }
function pesapi_set_private(env, pobject, ptr) { return false; }
function pesapi_get_property_uint32(env, pobject, key) { return 0; }
...
// --------------- 全局对象 ---------------
function pesapi_global(env) { return 0; }
// --------------- 环境私有数据 ---------------
function pesapi_get_env_private(env) { return 0; }
...
exports["default"] = GetWebGLFFIApi;
    ...
    Init(ctorParam) {
        ...
        library_1.global.PuertsWebGL = Object.assign(library_1.global.PuertsWebGL, {
            ...
            GetWebGLFFIApi: function () {
                return (0, pesapiImpl_1.default)(engine);
            }
        });
    }
};
