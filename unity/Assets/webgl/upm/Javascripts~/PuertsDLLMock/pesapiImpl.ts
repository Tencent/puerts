...
// 类似地处理其他基础类型创建函数
function pesapi_create_uint32(env: pesapi_env, value: number): pesapi_value { return 0; }
function pesapi_create_int64(env: pesapi_env, value: bigint): pesapi_value { return 0; }
function pesapi_create_uint64(env: pesapi_env, value: bigint): pesapi_value { return 0; }
function pesapi_create_double(env: pesapi_env, value: number): pesapi_value { return 0; }
...
function pesapi_create_array(env: pesapi_env): pesapi_value { return 0; }
function pesapi_create_object(env: pesapi_env): pesapi_value { return 0; }
...
// 类似处理其他类型获取
function pesapi_get_value_uint32(env: pesapi_env, pvalue: pesapi_value): number { return 0; }
function pesapi_get_value_int64(env: pesapi_env, pvalue: pesapi_value): bigint { return 0n; }
function pesapi_get_value_uint64(env: pesapi_env, pvalue: pesapi_value): bigint { return 0n; }
function pesapi_get_value_double(env: pesapi_env, pvalue: pesapi_value): number { return 0; }
...
// --------------- 类型检查系列 ---------------
function pesapi_is_null(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_undefined(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_boolean(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_int32(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_uint32(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_int64(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_uint64(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_double(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_string(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_object(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_function(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_binary(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
function pesapi_is_array(env: pesapi_env, pvalue: pesapi_value): boolean { return false; }
...
// --------------- 装箱/拆箱 ---------------
function pesapi_boxing(env: pesapi_env, pvalue: pesapi_value): pesapi_value { return 0; }
function pesapi_unboxing(env: pesapi_env, p_boxed_value: pesapi_value): pesapi_value { return 0; }
function pesapi_update_boxed_value(env: pesapi_env, p_boxed_value: pesapi_value, pvalue: pesapi_value): void {}
function pesapi_is_boxed_value(env: pesapi_env, value: pesapi_value): boolean { return false; }

// --------------- 函数调用相关 ---------------
function pesapi_get_args_len(pinfo: pesapi_callback_info): number { return 0; }
function pesapi_get_arg(pinfo: pesapi_callback_info, index: number): pesapi_value { return 0; }
function pesapi_get_env(pinfo: pesapi_callback_info): pesapi_env { return 0; }
function pesapi_get_this(pinfo: pesapi_callback_info): pesapi_value { return 0; }
function pesapi_get_holder(pinfo: pesapi_callback_info): pesapi_value { return 0; }
function pesapi_get_userdata(pinfo: pesapi_callback_info): number { return 0; }
...
// --------------- 环境引用 ---------------
function pesapi_create_env_ref(env: pesapi_env): pesapi_env_ref { return 0; }
function pesapi_env_ref_is_valid(penv_ref: pesapi_env_ref): boolean { return false; }
function pesapi_get_env_from_ref(penv_ref: pesapi_env_ref): pesapi_env { return 0; }
function pesapi_duplicate_env_ref(penv_ref: pesapi_env_ref): pesapi_env_ref { return 0; }
function pesapi_release_env_ref(penv_ref: pesapi_env_ref): void {}

// --------------- 作用域管理 ---------------
function pesapi_open_scope(penv_ref: pesapi_env_ref): pesapi_scope { return 0; }
function pesapi_open_scope_placement(penv_ref: pesapi_env_ref, memory: number): pesapi_scope { return 0; }
function pesapi_has_caught(pscope: pesapi_scope): boolean { return false; }
function pesapi_get_exception_as_string(pscope: pesapi_scope, with_stack: boolean): string { return ""; }
function pesapi_close_scope(pscope: pesapi_scope): void {}
function pesapi_close_scope_placement(pscope: pesapi_scope): void {}

// --------------- 值引用 ---------------
function pesapi_create_value_ref(env: pesapi_env, pvalue: pesapi_value, internal_field_count: number): pesapi_value_ref { return 0; }
function pesapi_duplicate_value_ref(pvalue_ref: pesapi_value_ref): pesapi_value_ref { return 0; }
function pesapi_release_value_ref(pvalue_ref: pesapi_value_ref): void {}
function pesapi_get_value_from_ref(env: pesapi_env, pvalue_ref: pesapi_value_ref): pesapi_value { return 0; }
function pesapi_set_ref_weak(env: pesapi_env, pvalue_ref: pesapi_value_ref): void {}
function pesapi_set_owner(env: pesapi_env, pvalue: pesapi_value, powner: pesapi_value): boolean { return false; }
function pesapi_get_ref_associated_env(value_ref: pesapi_value_ref): pesapi_env_ref { return 0; }
function pesapi_get_ref_internal_fields(pvalue_ref: pesapi_value_ref, pinternal_field_count: number): number { return 0; }

// --------------- 属性操作 ---------------
function pesapi_get_property(env: pesapi_env, pobject: pesapi_value, key: string): pesapi_value { return 0; }
function pesapi_set_property(env: pesapi_env, pobject: pesapi_value, key: string, pvalue: pesapi_value): void {}
function pesapi_get_private(env: pesapi_env, pobject: pesapi_value, out_ptr: number): boolean { return false; }
function pesapi_set_private(env: pesapi_env, pobject: pesapi_value, ptr: number): boolean { return false; }
function pesapi_get_property_uint32(env: pesapi_env, pobject: pesapi_value, key: number): pesapi_value { return 0; }
...
// --------------- 全局对象 ---------------
function pesapi_global(env: pesapi_env): pesapi_value { return 0; }

// --------------- 环境私有数据 ---------------
function pesapi_get_env_private(env: pesapi_env): number { return 0; }
...
export default function GetWebGLFFIApi(engine: PuertsJSEngine) {
