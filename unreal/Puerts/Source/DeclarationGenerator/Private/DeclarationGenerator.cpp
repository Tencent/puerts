...
bool FTypeScriptDeclarationGenerator::GenTypeDecl(FStringBuffer& StringBuffer, PropertyMacro* Property, TArray<UObject*>& AddToGen,
    FNameGuidInfo* info, bool ArrayDimProcessed, bool TreatAsRawFunction)
{
...
// #lizard forgives
bool FTypeScriptDeclarationGenerator::GenFunction(FStringBuffer& OwnerBuffer, UFunction* Function, FNameGuidInfo* info,
    bool WithName, bool ForceOneway, bool IgnoreOut, bool IsExtensionMethod)
{
...
private:
    ...
    void GenUeDts()
    {
        ...
        if (FFileHelper::LoadFileToString(jsonAssetStr, *(jsonAssetPath)) &&
            FFileHelper::LoadFileToString(jsonCodeStr, *(jsonCodePath)))
        {
