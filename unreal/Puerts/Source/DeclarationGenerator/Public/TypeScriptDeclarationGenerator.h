...
struct DECLARATIONGENERATOR_API FTypeScriptDeclarationGenerator
{
    ...
    virtual bool GenTypeDecl(FStringBuffer& StringBuffer, PropertyMacro* Property, TArray<UObject*>& AddToGen, FNameGuidInfo* info = nullptr,
        bool ArrayDimProcessed = false, bool TreatAsRawFunction = false);

    virtual bool GenFunction(FStringBuffer& OwnerBuffer, UFunction* Function,FNameGuidInfo* info=nullptr, bool WithName = true, bool ForceOneway = false,
