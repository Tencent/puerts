...
public class DeclarationGenerator : ModuleRules
{
    public DeclarationGenerator(ReadOnlyTargetRules target) : base(target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[] {
            "Core", "CoreUObject", "UMG", "UnrealEd", "LevelEditor", "Engine", "Slate", "SlateCore", "EditorStyle", "InputCore",
                "Projects", "JsEnv", "Puerts", "Json", "JsonUtilities",
#if UE_5_0_OR_LATER
                "ToolMenus",
#endif
        });
        ...
        // PublicDefinitions.Add(string.Format("DECL_OUTPUT_PATH={0}", Path.GetFullPath(Path.Combine(ModuleDirectory, "..", "..",
        // "Content", "Scripts"))));
    }
}
