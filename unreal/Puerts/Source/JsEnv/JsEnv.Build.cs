...
public class JsEnv : ModuleRules
{
    ...
    void OldThirdParty(ReadOnlyTargetRules Target)
    {
        ...
        else if (Target.Platform == UnrealTargetPlatform.Android)
        {
            ...
            {
                string ARMv7aLibPath = Path.Combine(LibraryPath, "V8", "Android", "armv7a-release", "8.4.371.19");
                string ARM64LibPath = Path.Combine(LibraryPath, "V8", "Android", "arm64-release", "8.4.371.19");

                PublicAdditionalLibraries.Add(Path.Combine(ARMv7aLibPath, "libwee8.a"));
                PublicAdditionalLibraries.Add(Path.Combine(ARM64LibPath, "libwee8.a"));
            }
            else if (Target.Version.MajorVersion == 4 && Target.Version.MinorVersion < 25)
            {
                string ARMv7aLibPath = Path.Combine(LibraryPath, "V8", "Android", "armv7a-release", "7.4.288");
                ...
                string ARM64LibPath = Path.Combine(LibraryPath, "V8", "Android", "arm64-release", "7.4.288");
    ...
    void ThirdParty(ReadOnlyTargetRules Target)
    {
        ...
        {
            string ARMv7aLibPath = Path.Combine(LibraryPath, "Android", "armv7");
            PublicAdditionalLibraries.Add(Path.Combine(ARMv7aLibPath, "libwee8.a"));

            string ARM64LibPath = Path.Combine(LibraryPath, "Android", "arm64");
            PublicAdditionalLibraries.Add(Path.Combine(ARM64LibPath, "libwee8.a"));
        }
        else if (Target.Platform == UnrealTargetPlatform.Mac)
        {
