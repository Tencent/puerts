...
static pesapi_func_ptr funcs[] = {(pesapi_func_ptr) &pesapi_create_null, (pesapi_func_ptr) &pesapi_create_undefined,
    ...
    (pesapi_func_ptr) &pesapi_get_value_double, (pesapi_func_ptr) &pesapi_get_value_string_utf8, (pesapi_func_ptr) &pesapi_is_null,
    ...
    (pesapi_func_ptr) &pesapi_is_function, (pesapi_func_ptr) &pesapi_create_native_object,
    ...
    (pesapi_func_ptr) &pesapi_call_function, (pesapi_func_ptr) &pesapi_alloc_type_infos, (pesapi_func_ptr) &pesapi_set_type_info,
