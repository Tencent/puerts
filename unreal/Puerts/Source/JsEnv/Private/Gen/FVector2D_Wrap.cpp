...
struct AutoRegisterForFVector2D
{
    AutoRegisterForFVector2D()
    {
        puerts::DefineClass<FVector2D>()
            ...
            .Method("Equals", MakeFunction(&FVector2D::Equals, UE_KINDA_SMALL_NUMBER))
            ...
            .Method("GetSafeNormal", MakeFunction(&FVector2D::GetSafeNormal, UE_SMALL_NUMBER))
            .Method("Normalize", MakeFunction(&FVector2D::Normalize, UE_SMALL_NUMBER))
            .Method("IsNearlyZero", MakeFunction(&FVector2D::IsNearlyZero, UE_KINDA_SMALL_NUMBER))
