...
struct pesapi_value_holder__
{
	explicit pesapi_value_holder__(v8::Local<v8::Context> context, v8::Local<v8::Value> value)
		: isolate(context->GetIsolate()),
		value_persistent(isolate, value),
	    ref_count(1) {
	}
	v8::Isolate* const isolate;
...
pesapi_value pesapi_get_property(pesapi_env env, pesapi_value pobject, const char* key)
{
	...
	if (object->IsObject())
	{
		auto MaybeValue = object.As<v8::Object>()->Get(context,
...
pesapi_value pesapi_call_function(pesapi_env env, pesapi_value pfunc, pesapi_value this_object, int argc,
