...
/**
 * @defgroup read_at puerts_asio::read_at
 *
 ...
 * @code puerts_asio::read_at(d, 42, puerts_asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code puerts_asio::read_at(
 *     d, 42, buffers,
 *     puerts_asio::transfer_all()); @endcode
 */
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code puerts_asio::read_at(d, 42,
 *     puerts_asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @code puerts_asio::read_at(
 *     d, 42, buffers,
 *     puerts_asio::transfer_all(), ec); @endcode
 */
template <typename SyncRandomAccessReadDevice, typename MutableBufferSequence>
std::size_t read_at(SyncRandomAccessReadDevice& d,
    uint64_t offset, const MutableBufferSequence& buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code puerts_asio::read_at(d, 42, puerts_asio::buffer(data, size),
 *     puerts_asio::transfer_at_least(32)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 */
...
std::size_t read_at(SyncRandomAccessReadDevice& d,
    uint64_t offset, const MutableBufferSequence& buffers,
    CompletionCondition completion_condition, puerts_asio::error_code& ec);
...
/*@}*/
/**
 * @defgroup async_read_at puerts_asio::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * puerts_asio::async_read_at(d, 42, puerts_asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code puerts_asio::async_read_at(
 *     d, 42, buffers,
 *     puerts_asio::transfer_all(),
 *     handler); @endcode
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code puerts_asio::async_read_at(d, 42,
 *     puerts_asio::buffer(data, size),
 *     puerts_asio::transfer_at_least(32),
 *     handler); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
