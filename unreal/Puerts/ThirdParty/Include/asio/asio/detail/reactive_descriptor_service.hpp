...
public:
  ...
  class implementation_type
    : private puerts_asio::detail::noncopyable
  {
  public:
    // Default constructor.
    implementation_type()
  ...
  puerts_asio::error_code io_control(implementation_type& impl,
  ...
  puerts_asio::error_code non_blocking(implementation_type& impl,
  ...
  puerts_asio::error_code native_non_blocking(implementation_type& impl,
      bool mode, puerts_asio::error_code& ec)
  {
  ...
  puerts_asio::error_code wait(implementation_type& impl,
      posix::descriptor_base::wait_type w, puerts_asio::error_code& ec)
  {
    switch (w)
    {
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, puerts_asio::error_code& ec)
  {
