  ...
  : handle_(0)
{
  ...
  case context::sslv2_server:
    puerts_asio::detail::throw_error(
        puerts_asio::error::invalid_argument, "context");
    break;
  ...
  if (handle_ == 0)
  {
    ...
    puerts_asio::detail::throw_error(ec, "context");
  }
...
void context::clear_options(context::options o)
{
  puerts_asio::error_code ec;
  clear_options(o, ec);
  puerts_asio::detail::throw_error(ec, "clear_options");
}

ASIO_SYNC_OP_VOID context::clear_options(
    context::options o, puerts_asio::error_code& ec)
{
...
void context::set_options(context::options o)
{
  puerts_asio::error_code ec;
  set_options(o, ec);
  puerts_asio::detail::throw_error(ec, "set_options");
}
    ...
    context::options o, puerts_asio::error_code& ec)
{
  ...
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      puerts_asio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
void context::set_verify_mode(verify_mode v)
{
  ...
  puerts_asio::detail::throw_error(ec, "set_verify_mode");
}
...
void context::set_verify_depth(int depth)
{
  ...
  puerts_asio::detail::throw_error(ec, "set_verify_depth");
}
...
void context::load_verify_file(const std::string& filename)
{
  ...
  puerts_asio::detail::throw_error(ec, "load_verify_file");
}
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  puerts_asio::detail::throw_error(ec, "add_certificate_authority");
}
...
void context::set_default_verify_paths()
{
  ...
  puerts_asio::detail::throw_error(ec, "set_default_verify_paths");
}
...
void context::add_verify_path(const std::string& path)
{
  ...
  puerts_asio::detail::throw_error(ec, "add_verify_path");
}
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  puerts_asio::detail::throw_error(ec, "use_certificate");
}
    ...
    const std::string& filename, file_format format)
{
  ...
  puerts_asio::detail::throw_error(ec, "use_certificate_file");
}
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  puerts_asio::detail::throw_error(ec, "use_certificate_chain");
}
    ...
    const const_buffer& chain, puerts_asio::error_code& ec)
{
  ...
  if (bio.p)
  {
    ...
    if (!cert.p)
    {
      ec = puerts_asio::error_code(ERR_R_PEM_LIB,
          puerts_asio::error::get_ssl_category());
      ASIO_SYNC_OP_VOID_RETURN(ec);
    }
...
void context::use_certificate_chain_file(const std::string& filename)
{
  ...
  puerts_asio::detail::throw_error(ec, "use_certificate_chain_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  puerts_asio::detail::throw_error(ec, "use_private_key");
}
    ...
    const std::string& filename, context::file_format format)
{
  ...
  puerts_asio::detail::throw_error(ec, "use_private_key_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  puerts_asio::detail::throw_error(ec, "use_rsa_private_key");
}
    ...
    const std::string& filename, context::file_format format)
{
  ...
  puerts_asio::detail::throw_error(ec, "use_rsa_private_key_file");
}
...
void context::use_tmp_dh(const const_buffer& dh)
{
  puerts_asio::error_code ec;
  use_tmp_dh(dh, ec);
  puerts_asio::detail::throw_error(ec, "use_tmp_dh");
}
...
void context::use_tmp_dh_file(const std::string& filename)
{
  ...
  puerts_asio::detail::throw_error(ec, "use_tmp_dh_file");
}
