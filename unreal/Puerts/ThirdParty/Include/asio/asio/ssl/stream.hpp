 ...
 * @code
 * puerts_asio::io_context my_context;
 * puerts_asio::ssl::context ctx(puerts_asio::ssl::context::sslv23);
 * puerts_asio::ssl::stream<asio:ip::tcp::socket> sock(my_context, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
  ...
  void handshake(handshake_type type)
  {
    puerts_asio::error_code ec;
    handshake(type, ec);
    puerts_asio::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  ASIO_SYNC_OP_VOID shutdown(puerts_asio::error_code& ec)
  {
...
private:
  ...
  public:
        ...
        handshake_type type) const
    {
      ...
      puerts_asio::detail::non_const_lvalue<HandshakeHandler> handler2(handler);
  ...
  public:
        ...
        handshake_type type, const ConstBufferSequence& buffers) const
    {
      ...
      puerts_asio::detail::non_const_lvalue<
  ...
  public:
    ...
    void operator()(ASIO_MOVE_ARG(ShutdownHandler) handler) const
    {
      ...
      puerts_asio::detail::non_const_lvalue<ShutdownHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const ConstBufferSequence& buffers) const
    {
      ...
      puerts_asio::detail::non_const_lvalue<WriteHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const MutableBufferSequence& buffers) const
    {
      ...
      puerts_asio::detail::non_const_lvalue<ReadHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
