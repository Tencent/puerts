...
namespace detail
{
      ...
      puerts_asio::error_code& ec)
  {
    ...
    puerts_asio::detail::consuming_buffers<mutable_buffer,
    ...
    uint64_t offset, const MutableBufferSequence& buffers)
{
  ...
  puerts_asio::detail::throw_error(ec, "read_at");
...
namespace detail
{
  ...
  //private:
    typedef puerts_asio::detail::consuming_buffers<mutable_buffer,
