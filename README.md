...
* git clone https://github.com/Tencent/puerts.git puerts --recursive

* 拷贝插件到您项目

    - unreal engine: 拷贝位于unreal下的Puerts目录到您项目的Plugins目录下，可以参考demo工程
    
    - unity： 拷贝unity/Assets下的所有内容到您项目的Assets目录下
