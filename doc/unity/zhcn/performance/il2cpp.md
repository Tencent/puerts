...
* 如果你期待更高的性能，生成全量胶水代码：点击Unity的`Tools/PuerTS/il2cpp/Generate All (Static Wrapper Mode)`。

* 如果你期待更小的代码量，仅生成基于反射的胶水代码：点击Unity的`Tools/PuerTS/il2cpp/Generate All (Reflection Mode)`。

* 如果你希望进一步精简生成产物（最小化 Bridge 代码），同时使用反射模式：点击Unity的`Tools/PuerTS/il2cpp/Generate All (Minimal Bridge, Reflection Mode)`。
